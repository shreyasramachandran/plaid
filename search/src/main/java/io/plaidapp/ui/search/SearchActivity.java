...
public class SearchActivity extends Activity {
            ...
            public void onDataLoaded(List<? extends PlaidItem> data) {
                if (data != null && data.size() > 0) {
                    ...
                    TransitionManager.beginDelayedTransition(
                            container, getTransition(io.plaidapp.R.transition.auto));
                    progress.setVisibility(View.GONE);
    ...
    void clearResults() {
        TransitionManager.beginDelayedTransition(container,
                getTransition(io.plaidapp.R.transition.auto));
        adapter.clear();
        dataManager.clear();
    ...
    void setNoResultsVisibility(int visibility) {
        if (visibility == View.VISIBLE) {
            ...
            String message = String.format(
                    getString(io.plaidapp.R.string.no_search_results), searchView.getQuery().toString());
    ...
    private void setupSearchView() {
        ...
        searchView.setQueryHint(getString(io.plaidapp.R.string.search_hint));
